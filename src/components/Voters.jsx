  ...
  return (
    <div className="flex flex-col p-8">
        ...
        <div className="mt-4 text-center">
            ...
            <button
                aria-current="page"
                className="bg-transparent px-4 py-2.5 font-medium leading-tight uppercase text-blue-600 text-xs rounded-full shadow-md shadow-gray-400 active:bg-blue-800 dark:shadow-transparent transition duration-150 ease-in-out dark:border dark:border-blue-500 border border-blue-600 hover:text-white hover:bg-blue-600"
            >
                Load More
            </button>
            ) : null}
